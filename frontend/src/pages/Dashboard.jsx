          ...
          <div style={{ height: "280px" }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={charts.vehicle_type_counts}>
                <XAxis dataKey="label" stroke="#4b0000" tick={{ fill: "#ffffff", fontSize: 12 }} />
                <YAxis stroke="#4b0000" tick={{ fill: "#ffffff", fontSize: 12 }} />
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  ...
                  label={({ cx, cy, midAngle, outerRadius, type, count }) => {
        ...
        <div style={{ height: "280px" }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={charts.vehicle_model_counts}>
              <XAxis dataKey="model" stroke="#4b0000" tick={{ fill: "#ffffff", fontSize: 12 }} />
              <YAxis stroke="#4b0000" tick={{ fill: "#ffffff", fontSize: 12 }} />
              <Tooltip contentStyle={CHART_TOOLTIP_STYLE} cursor={{ fill: "rgba(149,1,1,0.1)" }} />
